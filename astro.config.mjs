...
export default defineConfig({
  ...
  integrations: [starlight({
      ...
      sidebar: [
        { label: 'Basics & Syntax', collapsed: true, items: [{ autogenerate: { directory: 'basics' } }] },
        { label: 'Ownership & Borrowing', collapsed: true, items: [{ autogenerate: { directory: 'ownership-borrowing' } }] },
        { label: 'Structs, Enums & Pattern Matching', collapsed: true, items: [{ autogenerate: { directory: 'structs-enums-matching' } }] },
        { label: 'Traits & Generics', collapsed: true, items: [{ autogenerate: { directory: 'traits-generics' } }] },
        { label: 'Error Handling', collapsed: true, items: [{ autogenerate: { directory: 'error-handling' } }] },
        { label: 'Collections & Iterators', collapsed: true, items: [{ autogenerate: { directory: 'collections-iterators' } }] },
        { label: 'Concurrency, Testing & Cargo', collapsed: true, items: [{ autogenerate: { directory: 'concurrency-testing-cargo' } }] },
      ],
      }), preact()],
});